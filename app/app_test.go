...
func NewTestApp(t *testing.T) (*App[transaction.Tx], context.Context) {
	t.Helper()
	...
	app, err := NewApp[transaction.Tx](depinject.Configs(
...
func TestAppExportAndBlockedAddrs_WithOneBlockProduced(t *testing.T) {
...
func TestAppExportAndBlockedAddrs_NoBlocksProduced(t *testing.T) {
	app, _ := NewTestApp(t)
